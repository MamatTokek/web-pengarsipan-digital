        ...
        <div class="flex items-center gap-3 w-full md:w-1/2 justify-end">
                ...
                <div x-show="openFilter" @click.away="openFilter = false"
                    ...
                    <form action="{{ route('kades.documents.index') }}" method="GET" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="type" class="w-full p-2 border border-gray-300 rounded-md text-sm">
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full p-2 border border-gray-300 rounded-md text-sm">
                        ...
                        <div>
                            ...
                            <select name="month" class="w-full p-2 border border-gray-300 rounded-md text-sm">
                        ...
                        <div>
                            ...
                            <select name="year" class="w-full p-2 border border-gray-300 rounded-md text-sm">
                        ...
                        <div class="pt-2 space-y-2">
                            <button type="submit" class="block w-full bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold py-2 px-4 rounded-lg transition duration-150 uppercase tracking-wider">
                                Terapkan
                            </button>
                            @if(request()->anyFilled(['category', 'type', 'search', 'month', 'year']))
                                <a href="{{ route('kades.documents.index') }}" class="block w-full text-center bg-red-600 hover:bg-red-700 text-white text-xs font-bold py-2 px-4 rounded-lg transition duration-150 uppercase tracking-wider">
                                    Reset
                                </a>
                            @endif
                        </div>
            ...
            <div class="w-full md:w-64">
                <form method="GET" action="{{ route('kades.documents.index') }}">
                    {{-- Hidden inputs agar filter tidak hilang saat mencari teks --}}
                    ...
                    <div class="relative">
                        <input type="text" name="search" placeholder="Cari dokumen..." value="{{ request('search') }}"
                               class="w-full p-2 pl-10 border border-gray-300 rounded-lg text-sm focus:ring-indigo-500 shadow-sm">
