...
<div class="bg-white p-6 rounded-lg shadow-md" x-data="{ openFilter: false, openModal: false, previewUrl: '', previewTitle: '', qrUrl: '' }">
    ...
    {{-- Header Kontrol (PERBAIKAN: Mengubah md:items-center menjadi md:items-end) --}}
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-6 gap-4">
        ...
        {{-- Sisi Kanan: Filter + Pencarian Sejajar Sempurna --}}
        <div class="w-full md:w-auto flex justify-end">

            {{-- FORM UTAMA (PERBAIKAN: Menambahkan h-full / items-center untuk mengunci elemen sebaris) --}}
            <form method="GET" action="{{ route('kades.documents.index') }}" class="flex items-center gap-3 w-full md:w-auto">

                {{-- Pertahankan parameter filter saat mengetik di search bar --}}
                ...
                <div class="relative inline-block text-left">
                    ...
                    <div x-show="openFilter" @click.away="openFilter = false"
                        ...
                        <div class="space-y-4">
                            ...
                            {{-- 2. Filter Kategori Surat (Kondisional) --}}
                            ...
                            {{-- 2.5 Filter Status Surat (Kondisional) --}}
                            ...
                            {{-- 3. Filter Kategori Arsip (Kondisional) --}}
                            ...
                            <div class="pt-2 space-y-2">
                                ...
                                @if($currentDocType || $currentCategory || $currentStatus || $currentMonth || $currentYear != date('Y') || request('search'))
                                    <a href="{{ route('kades.documents.index') }}" class="block w-full text-center bg-red-600 hover:bg-red-700 text-white text-xs font-bold py-2 px-4 rounded-lg shadow-md transition duration-150 uppercase tracking-wider">
                                        Reset
                                    </a>
                                @endif
                            </div>
