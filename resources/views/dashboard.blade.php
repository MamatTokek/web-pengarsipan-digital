...
@section('content')
    ...
    <div x-data="{ openModal: false, previewUrl: '', previewTitle: '', qrUrl: '' }">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            {{-- 2. Baris Flex Judul dan Filter Popover --}}
            <div class="flex justify-between items-center mb-4">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-16">No.</th>                           <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-64">Informasi Dokumen</th>
